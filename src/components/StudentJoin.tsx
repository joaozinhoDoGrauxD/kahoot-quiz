...
export default function StudentJoin({
  ...
  onJoin: (pin: string, studentId: string) => void;
}) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0A0A0B] text-[#E4E4E7]">
      <div className="bg-[#141416] p-8 rounded-xl border border-[#27272A] w-full max-w-sm text-center shadow-2xl">
        <h2
          id="student-join-heading"
          className="text-3xl font-black mb-2 text-[#D4AF37]"
        >
          Entrar no Quiz
        </h2>
        ...
        {error && (
          <p id="error" className="text-red-500 mb-4 font-bold">
            {error}
          </p>
        )}
